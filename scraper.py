...
class NHLScraper(Spider):
	...
	def parse(self, response):
		...
		for row in rows:
			...
			current_player["games_played"] = row.xpath("td[@class='yspscores'][5]/text()")[0].extract()
			current_player["goals"] = row.xpath("td[@class='yspscores'][7]/text()")[0].extract()
			current_player["assists"] = row.xpath("td[@class='ysptblclbg6']/span/text()")[0].extract()
			current_player["points"] = row.xpath("td[@class='yspscores'][10]/text()")[0].extract()
			current_player["plus_minus"] = row.xpath("td[@class='yspscores'][12]/text()")[0].extract()
			current_player["pim"] = row.xpath("td[@class='yspscores'][14]/text()")[0].extract()
			current_player["hits"] = row.xpath("td[@class='yspscores'][16]/text()")[0].extract()
			current_player["bks"] = row.xpath("td[@class='yspscores'][18]/text()")[0].extract()
			current_player["fw"] = row.xpath("td[@class='yspscores'][20]/text()")[0].extract()
			current_player["fl"] = row.xpath("td[@class='yspscores'][22]/text()")[0].extract()
			current_player["fop"] = row.xpath("td[@class='yspscores'][24]/text()")[0].extract()
			current_player["ppg"] = row.xpath("td[@class='yspscores'][26]/text()")[0].extract()
